...
2. An exception can be raised when there is an issue with creating a new expense. It can encompass various scenarios, such as missing information or a failure to update balances.
3. An exception can be raised when a user attempts to access a group that doesn't exist or is not a member of.
